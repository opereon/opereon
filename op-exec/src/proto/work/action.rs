...
impl Action {
    pub fn create(_model: &Model, _procedure: &ProcDef, task: &TaskDef, _host: &HostDef, _work: &Work, _job: &Job) -> Result<Action, ProtoError> {
        Ok(Action {
...
impl ActionResult {
    pub fn new(outcome: Outcome, status: Option<i32>, signal: Option<i32>) -> ActionResult {
        ActionResult {
            outcome,
            status,
            signal,
